...
const ProDescriptions1 = () => {
  return (
    <ProDescriptions column={2} title="高级定义列表" tooltip="包含了服务请求,columns等功能">
      ...
      <ProDescriptions.Item
        ...
        label="文本"
      >
        Lorem ipsum dolor, sit amet consectetur adipisicing elit. Numquam commodi consequuntur doloribus quam
        laboriosam, fuga officiis neque ratione reprehenderit, non distinctio deserunt nam itaque fugiat, sapiente ipsam
        odit et iste?
      </ProDescriptions.Item>
...
ProDescriptions1.menu = {
  name: '演示',
};

export default ProDescriptions1;
