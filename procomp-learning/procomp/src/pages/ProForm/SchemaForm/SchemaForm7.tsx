      ...
      columns: [
        {
          ...
          valueEnum: ['select', 'checkbox', 'radio', 'radioButton'].includes(valueType) ? valueEnum : undefined,
          fieldProps:
        ...
        },
        {
          valueType,
          title: '只读',
          dataIndex: valueType + 'readonly' || 'text',
          valueEnum,
          readonly: true,
          width: 'm',
        },
      ...
      <BetaSchemaForm
        ...
        initialValues={options.reduce((pre, item) => {
          return {
            ...
            [item.value + 'readonly']: item.initialValue,
          };
        }, {})}
        columns={columns}
      />
