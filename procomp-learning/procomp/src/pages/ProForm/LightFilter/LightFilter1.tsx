...
import { Radio, TreeSelect, Button } from 'antd';
    ...
    <div>
      ...
      <LightFilter<{
        ...
        initialValues={{
          ...
          timeRanger: [moment('2019-11-16 12:50:26').add(-1, 'd').valueOf(), moment('2019-11-16 12:50:26').valueOf()],
        }}
        size={size}
