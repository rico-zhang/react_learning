...
const ProList8 = () => {
  const [cardActionsProps, setcardActionsProps] = useState<'actions' | 'extra'>('extra');
  ...
  return (
    ...
    >
      <ProFormRadio.Group
        ...
        fieldProps={{
          value: cardActionsProps,
          onChange: (e) => setcardActionsProps(e.target.value),
        }}
      />
      <ProFormSwitch
        label="幽灵模式"
